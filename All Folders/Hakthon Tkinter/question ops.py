...
def askQuestion():
    ...
    if(len(questions) == index + 1):
        Label(window, text="Thank you for answering the questions. " + str(right) + " of " + str(number_of_questions) + " questions answered right",pady=30,padx=20,fg="black",bg="sky blue").pack()
        return
    button.pack_forget()
    index += 1
...
button = Button(window, text="START", command=askQuestion,fg="blue",bg="red",height=5,width=10)
button.pack()
...
class Application(tk.Frame):
    ...
    def create_widgets(self):
        ...
        self.quit = tk.Button(self, text="QUIT", fg="red",height=5,width=5,
