...
from topmovie2 import group_by_yea_top_movie
import pprint
import json

scrapped=sracp_movie()
decade_arenge=group_by_yea_top_movie(scrapped)
def New_group_by_decade(movies):
    list=[]
    dict={}
    ...
    for i in dict:
        ...
        with open("top_movie_3.json","w") as num:
            json.dump(dict,num,indent=6)

    return dict
New_group_by_decade(decade_arenge)
